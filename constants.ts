...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'fadec',
    title: 'FADEC Test Stand',
    refDes: 'U101',
    description: 'Test Engineer at BAE Systems',
    objective: 'Design and deploy a comprehensive test stand for a Large Full Authority Digital Engine Control (FADEC) unit.',
    ...
    context: 'Testing engine controllers requires simulating extreme operating conditions on the ground. The test stand acts as the "engine" during verification.',
